...
const Achivments = () => {
  return (
    ...
    <p className='text-sm text-designColor tracking-[4px] font-bold'style={{fontSize:"20px"}}>2020-2023</p>
    <h2 className='text-4x1 font-bold ' style={{fontSize:"30px"}}>My Achivements</h2>
    </div>
