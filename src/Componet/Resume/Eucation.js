...
const Eucation = () => {
  return (
    ...
    <p className='text-sm text-designColor tracking-[4px] font-bold'style={{fontSize:"20px"}}>2014-2023</p>
    <h2 className='text-3xl md:text-4xl font-bold ' style={{fontSize:"30px"}}>Education Qulification</h2>
    </div>
    <div className='int-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10'>
        <ResumeCard
    ...
    <div className='py-6 lgl:py-12 font titleFont'>
    <p className='text-sm text-designColor tracking-[4px] font-bold'style={{fontSize:"20px"}}>2014-2023</p>
    <h2 className='text-3xl md:text-4xl font-bold ' style={{fontSize:"30px"}}>Certificates</h2>
    </div>
    <div className='int-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10'>
        <ResumeCard
